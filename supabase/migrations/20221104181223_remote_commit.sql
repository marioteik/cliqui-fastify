...
CREATE FUNCTION "public"."handle_new_user"() RETURNS "trigger"
    ...
    AS $$
begin
  insert into public.profiles (id, cell_phone, full_name, avatar_url)
  values (new.id, new.raw_user_meta_data->>'cell_phone', new.raw_user_meta_data->>'full_name', new.raw_user_meta_data->>'avatar_url');
  return new;
end;
$$;
...
--
-- Name: categories categories_type_key; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."categories"
    ADD CONSTRAINT "categories_type_key" UNIQUE ("type");
...
--
-- Name: categories categories_parent_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
